  ...
  ar: {
    ...
    strengths: {
      ...
      items: [
        ...
        {title: 'استخدام احترافي', description: 'طُوّرت لفرق الصيانة والخدمة.'},
        {title: 'العلامة الخاصة', description: 'تركيبة وعبوة وملصق مخصص لعلامتك.'},
      ],
    },
    industries: {
    ...
    cta: {
      ...
      description: 'تحدث مع فريقنا حول المنتجات وتصنيع العلامة الخاصة والاحتياجات الفنية.',
      quote: 'اطلب عرض سعر',
      contact: 'تواصل معنا',
    },
  },
