...
export async function generateMetadata({params}: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    locale: localeParam,
    fallbackTitle: dictionary.pages.quoteTitle,
    fallbackDescription: dictionary.pages.quoteDescription,
    path: '/request-a-quote',
  })
}

export default async function RequestQuotePage({params, searchParams}: PageProps) {
  const {locale: localeParam} = await params
  ...
  const steps = [
    {
      title: dictionary.quotePage.step1Title,
      body: dictionary.quotePage.step1Body,
    },
    {
      title: dictionary.quotePage.step2Title,
      body: dictionary.quotePage.step2Body,
    },
    {
      title: dictionary.quotePage.step3Title,
      body: dictionary.quotePage.step3Body,
    },
  ]
          ...
          <aside className="border-border py-12 lg:border-e lg:py-16 lg:pe-12">
            ...
            >
              <p className="text-xs font-semibold tracking-[0.18em] text-muted uppercase">
                {dictionary.quotePage.directContact}
              </p>
              ...
              <p className="mt-5 text-xs tracking-wide text-muted">
                {dictionary.quotePage.responseTime}
              </p>
            </div>
          </aside>
          ...
          <div className="py-12 lg:py-16 lg:ps-12">
            ...
            >
              <h2 className="font-display text-3xl text-foreground">
                {dictionary.quotePage.formTitle}
              </h2>
              <p className="mt-3 max-w-xl text-sm leading-relaxed text-muted">
                {dictionary.quotePage.formHint}
              </p>
            </div>
            ...
            >
              ...
              <QuoteForm
                ...
                locale={locale}
                defaultProductInterest={product?.trim() || undefined}
              />
            </div>
          </div>
        </div>
